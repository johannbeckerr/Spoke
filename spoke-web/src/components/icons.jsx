...
// 6) Hamburger menu — three heavy bars, squared-off ends
export function MenuIcon(props) {
  return (
    <svg {...OUTLINE_PROPS} strokeWidth={3.5} {...props}>
...
// 7) Close (X) — same heavy stroke as the hamburger it replaces
...
// 8) Spoke wordmark glyph — replaces the "o" in "Spoke"
